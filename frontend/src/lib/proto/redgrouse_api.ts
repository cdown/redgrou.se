...
export const ApiErrorBody = {
  encode(message: ApiErrorBody, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.error !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ApiErrorBody {
...
function createBaseUploadMetadata(): UploadMetadata {
  return { uploadId: "", filename: "", rowCount: 0 };
}

export const UploadMetadata = {
  encode(message: UploadMetadata, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.uploadId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): UploadMetadata {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseUploadResponse(): UploadResponse {
  return { uploadId: "", filename: "", rowCount: 0, editToken: "" };
}
...
export const FieldMetadataList = {
  encode(message: FieldMetadataList, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    for (const v of message.fields) {
      FieldMetadata.encode(v!, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): FieldMetadataList {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FieldValues = {
  encode(message: FieldValues, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.field !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): FieldValues {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BboxResponse = {
  encode(message: BboxResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.minLng !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BboxResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Sighting = {
  encode(message: Sighting, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Sighting {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GroupedSighting = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GroupedSighting {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.speciesCount = longToNumber(reader.int64() as Long);
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
...
export const SightingsResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SightingsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
